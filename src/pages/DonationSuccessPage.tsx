    ...
    <div className="min-h-screen flex flex-col donor-portal">
      ...
      <main className="flex-grow">
        <div className="max-w-[820px] mx-auto px-6 md:px-10 py-24">
          ...
          <h1 className="text-4xl md:text-5xl mb-6" style={{ fontFamily: "var(--font-serif)" }}>
            Thank you.
          </h1>
          <p className="text-[16px] leading-relaxed mb-6">
            Your submission has been received. The Trust will confirm settlement and issue formal
            acknowledgement to the email address on your donor account.
          </p>
          {sessionId && (
            <p className="text-xs text-muted-foreground mb-8">Reference: {sessionId}</p>
          )}
