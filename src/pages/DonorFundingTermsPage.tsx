...
// Reuses the generic LegalDocumentPage renderer by providing the slug directly,
// so the route /donor-project-funding-terms matches the exact spec.
  ...
  return (
    <div className="max-w-3xl mx-auto px-6 md:px-10 py-14">
      <Helmet>
        ...
        <meta
          name="description"
          content={doc?.summary || "Terms on which donations to Global Health Access Trust are given, allocated (20% operating / 80% delivery), used, reported and, where applicable, refunded."}
        />
      ...
      {loading ? (
        ...
        <article className="mt-6">
          <div className="text-xs uppercase tracking-widest text-muted-foreground">Donation</div>
