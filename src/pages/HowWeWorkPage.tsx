      ...
      <div className="container-section py-16">
        <Card>
          <CardContent className="prose prose-lg max-w-none p-8">
            <h1 className="text-4xl font-serif font-bold mb-8">How We Work</h1>
            ...
            <h2 className="text-2xl font-semibold mt-8 mb-4">1. Purpose-Led Programming</h2>
            ...
            <h2 className="text-2xl font-semibold mt-8 mb-4">2. Receiving and Reviewing Proposals</h2>
            ...
            <h2 className="text-2xl font-semibold mt-8 mb-4">3. Grant-Making Process</h2>
            ...
            <h2 className="text-2xl font-semibold mt-8 mb-4">4. Partner Engagement</h2>
            ...
            <p>We are not a funding agency. We are a legacy institution. Partners must reflect that standard.</p>

            <h2 className="text-2xl font-semibold mt-8 mb-4">5. Independence and Discretion</h2>
            ...
            <p>We are built to endure. And with that comes the duty to act slowly, wisely, and with care.</p>

            <h2 className="text-2xl font-semibold mt-8 mb-4">Final Note</h2>
