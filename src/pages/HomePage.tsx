    ...
    <>
      ...
      <div className="flex flex-col">
        ...
        <section className="py-16 md:py-20 lg:py-24">
          <div className="max-w-[780px] mx-auto px-6 sm:px-8 lg:px-12">
            ...
            <div className="section-container">
              ...
              <div className="space-y-8">
                <div className="text-left">
                  <h3 className="mb-2 text-foreground">Scope Definition</h3>
                ...
                <div className="text-left">
                  <h3 className="mb-2 text-foreground">Progress Reporting</h3>
                  <p className="text-[15px] text-muted-foreground leading-[1.7]">
                ...
                <div className="text-left">
                  <h3 className="mb-2 text-foreground">Financial Transparency</h3>
                  <p className="text-[15px] text-muted-foreground leading-[1.7]">
