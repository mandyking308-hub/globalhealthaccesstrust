      ...
      <div className="container-section py-16">
        <Card>
          <CardContent className="prose prose-lg max-w-none p-8">
            <h1 className="text-4xl font-serif font-bold mb-8">Our Work</h1>
            ...
            <h2 className="text-2xl font-semibold mt-8 mb-4">1. Ethical Access to Healthcare</h2>
            ...
            <h2 className="text-2xl font-semibold mt-8 mb-4">2. Building Capacity, Not Dependency</h2>
            ...
            <h2 className="text-2xl font-semibold mt-8 mb-4">3. Strengthening Health Systems</h2>
            ...
            <h2 className="text-2xl font-semibold mt-8 mb-4">4. Legal Scholarship & Strategic Reform</h2>
            ...
            <h2 className="text-2xl font-semibold mt-8 mb-4">5. Responding to Humanitarian Collapse</h2>
            ...
            <h2 className="text-2xl font-semibold mt-8 mb-4">Readiness, Not Reaction</h2>
