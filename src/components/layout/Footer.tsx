        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 pb-16 border-b border-primary-foreground/15">
          <div className="lg:col-span-5">
            <div className="flex items-center gap-3 mb-8">
              <div className="w-7 h-7 bg-primary-foreground" aria-hidden="true" />
              <span className="font-serif text-lg font-extrabold uppercase tracking-tight leading-none">
                {SITE_CONFIG.shortName}
              </span>
            </div>
            <p className="font-serif text-2xl md:text-3xl leading-[1.2] font-medium max-w-xl tracking-tight">
          ...
          <div className="lg:col-span-7 grid grid-cols-2 md:grid-cols-3 gap-10">
            <div className="flex flex-col gap-3">
              <h5 className="text-[10.5px] font-bold uppercase tracking-[0.22em] text-primary-foreground/60 mb-2">Navigation</h5>
            ...
            <div className="flex flex-col gap-3">
              <h5 className="text-[10.5px] font-bold uppercase tracking-[0.22em] text-primary-foreground/60 mb-2">Governance</h5>
            ...
            <div className="flex flex-col gap-4 col-span-2 md:col-span-1">
              <h5 className="text-[10.5px] font-bold uppercase tracking-[0.22em] text-primary-foreground/60 mb-2">Correspondence</h5>
              ...
              <form onSubmit={handleNewsletterSubmit} className="mt-4">
                ...
                <div className="flex flex-col space-y-2">
                  ...
                  <Button
                    ...
                    className="text-[11px] tracking-[0.18em] uppercase font-bold h-10 rounded-none bg-primary-foreground text-primary hover:bg-primary-foreground/90"
                  >
