      ...
      <TooltipProvider>
        ...
        <Routes>
          ...
          <Route path="/" element={<Layout />}>
            ...
            <Route path="donor-recognition" element={<Navigate to="/support-the-trust" replace />} />
            ...
            <Route path="blog" element={<Navigate to="/publications" replace />} />
            <Route path="blog/:slug" element={<Navigate to="/publications" replace />} />
            <Route path="get-involved" element={<Navigate to="/contact-the-trust" replace />} />
            ...
            <Route path="security-incidents" element={<Navigate to="/protected-concerns/new" replace />} />
          </Route>
